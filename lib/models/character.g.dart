...
void _characterSerialize(
  ...
  writer.writeString(offsets[0], object.handle);
...
extension CharacterQueryFilter
  ...
  QueryBuilder<Character, Character, QAfterFilterCondition> handleEqualTo(
    String value, {
  ...
  QueryBuilder<Character, Character, QAfterFilterCondition> handleGreaterThan(
    String value, {
    bool include = false,
    bool caseSensitive = true,
  }) {
  ...
  QueryBuilder<Character, Character, QAfterFilterCondition> handleLessThan(
    String value, {
    bool include = false,
    bool caseSensitive = true,
  }) {
  ...
  QueryBuilder<Character, Character, QAfterFilterCondition> handleBetween(
    String lower,
    String upper, {
    bool includeLower = true,
    bool includeUpper = true,
  ...
  QueryBuilder<Character, Character, QAfterFilterCondition> handleStartsWith(
    String value, {
    bool caseSensitive = true,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Character, Character, QAfterFilterCondition> handleEndsWith(
    String value, {
    bool caseSensitive = true,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Character, Character, QAfterFilterCondition> handleContains(
      String value,
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Character, Character, QAfterFilterCondition> handleMatches(
      String pattern,
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Character, Character, QAfterFilterCondition> handleIsEmpty() {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.equalTo(
        property: r'handle',
        value: '',
  ...
  QueryBuilder<Character, Character, QAfterFilterCondition> handleIsNotEmpty() {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.greaterThan(
        property: r'handle',
        value: '',
...
extension CharacterQueryLinks
    on QueryBuilder<Character, Character, QFilterCondition> {
  QueryBuilder<Character, Character, QAfterFilterCondition> pics(
      FilterQuery<CharacterPic> q) {
    return QueryBuilder.apply(this, (query) {
      return query.link(q, r'pics');
    });
  }

  QueryBuilder<Character, Character, QAfterFilterCondition> picsLengthEqualTo(
      int length) {
    return QueryBuilder.apply(this, (query) {
      return query.linkLength(r'pics', length, true, length, true);
    });
  }

  QueryBuilder<Character, Character, QAfterFilterCondition> picsIsEmpty() {
    return QueryBuilder.apply(this, (query) {
      return query.linkLength(r'pics', 0, true, 0, true);
    });
  }

  QueryBuilder<Character, Character, QAfterFilterCondition> picsIsNotEmpty() {
    return QueryBuilder.apply(this, (query) {
      return query.linkLength(r'pics', 0, false, 999999, true);
    });
  }

  QueryBuilder<Character, Character, QAfterFilterCondition> picsLengthLessThan(
    int length, {
    bool include = false,
  }) {
    return QueryBuilder.apply(this, (query) {
      return query.linkLength(r'pics', 0, true, length, include);
    });
  }

  QueryBuilder<Character, Character, QAfterFilterCondition>
      picsLengthGreaterThan(
    int length, {
    bool include = false,
  }) {
    return QueryBuilder.apply(this, (query) {
      return query.linkLength(r'pics', length, include, 999999, true);
    });
  }

  QueryBuilder<Character, Character, QAfterFilterCondition> picsLengthBetween(
    int lower,
    int upper, {
    bool includeLower = true,
    bool includeUpper = true,
...
extension CharacterQuerySortBy on QueryBuilder<Character, Character, QSortBy> {
  QueryBuilder<Character, Character, QAfterSortBy> sortByHandle() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'handle', Sort.asc);
    });
  }

  QueryBuilder<Character, Character, QAfterSortBy> sortByHandleDesc() {
    return QueryBuilder.apply(this, (query) {
...
extension CharacterQuerySortThenBy
  ...
  QueryBuilder<Character, Character, QAfterSortBy> thenByHandle() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'handle', Sort.asc);
    });
  }

  QueryBuilder<Character, Character, QAfterSortBy> thenByHandleDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'handle', Sort.desc);
    });
  }
...
extension CharacterQueryWhereDistinct
  ...
  QueryBuilder<Character, Character, QDistinct> distinctByHandle(
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
...
extension CharacterQueryProperty
  ...
  QueryBuilder<Character, String, QQueryOperations> handleProperty() {
    return QueryBuilder.apply(this, (query) {
